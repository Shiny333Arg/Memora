...
class _PlaceTimeAlertFormPageState extends State<PlaceTimeAlertFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ⬇️ Reemplazo completo del body para evitar overflow (con y sin teclado)
      body: LayoutBuilder(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: const Text(
                          'Horario', style: TextStyle(color: Colors.white)),
                      subtitle: Text(
                          _startTime, style: const TextStyle(color: Colors
                          .white)),
